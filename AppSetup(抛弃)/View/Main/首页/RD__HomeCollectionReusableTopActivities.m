...
- (void) initializeWithView {
    ...
    [headView lqs_addTarget:self action:@selector(pressedControToDo)];
    ...
    UILabel* titleLabel = [UILabel lqs_text:@"热门活动" textColor:@"#555" fontSize:12];
...
- (NSInteger) collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section {
    ...
    NSUInteger count = [self.item.dataSourceArray lqs_length];
