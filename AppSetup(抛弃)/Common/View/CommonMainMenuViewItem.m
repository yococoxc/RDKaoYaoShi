...
- (void) initializeWithView {
    ...
    UILabel* numberLabel = [UILabel lqs_text:@"" textColor:_numberLabelTextColor fontSize:10];
    numberLabel.textAlignment = NSTextAlignmentCenter;
    numberLabel.lqs_backgroundColor = _numberLabelBackgroundColor;
    numberLabel.lqs_layerCornerRadius = 6;
    numberLabel.lqs_layerMasksToBounds = YES;
